...
--
-- Host: localhost
-- Generation Time: Jul 03, 2017 at 03:38 PM
...
CREATE TABLE `Division_List` (
  `ID` int(5) NOT NULL,
  `zone_id` varchar(10) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
  `div_id` varchar(10) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
  `division_name` varchar(50) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL
...
CREATE TABLE `Service` (
  ...
  `work_place_id` int(5) NOT NULL,
  `sub_location_id` int(5) NOT NULL,
...
ALTER TABLE `Province_Offices`
  ...
  ADD KEY `Province_Offices_fk1` (`province_id`) USING BTREE;
...
ALTER TABLE `Releasement_Place`
  ADD PRIMARY KEY (`ID`),
  ADD KEY `rel_type_id` (`rel_type_id`);
...
ALTER TABLE `Service`
  ...
  ADD KEY `Service_fk3` (`work_place_id`),
  ADD KEY `Service_fk4` (`sub_location_id`),
  ADD KEY `Service_fk5` (`designation_id`);
...
--
ALTER TABLE `Division_List`
  MODIFY `ID` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=312;
--
...
--
-- AUTO_INCREMENT for table `Main_Office_Branches`
--
ALTER TABLE `Main_Office_Branches`
  MODIFY `ID` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=91;
--
-- AUTO_INCREMENT for table `Main_Office_Divisions`
--
ALTER TABLE `Main_Office_Divisions`
...
ALTER TABLE `Institute`
  ...
  ADD CONSTRAINT `Institute_ibfk_1` FOREIGN KEY (`workplace_id`) REFERENCES `Work_Place` (`ID`);

--
-- Constraints for table `Main_Office_Branches`
--
ALTER TABLE `Main_Office_Branches`
  ADD CONSTRAINT `Main_Office_Branches_ibfk_1` FOREIGN KEY (`work_place_id`) REFERENCES `Work_Place` (`ID`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `Province_Offices`
  ...
  ADD CONSTRAINT `Province_Offices_fk1` FOREIGN KEY (`province_id`) REFERENCES `Province_List` (`province_id`);
...
--
ALTER TABLE `Releasement_Place`
  ADD CONSTRAINT `Releasement_Place_ibfk_1` FOREIGN KEY (`rel_type_id`) REFERENCES `Releasement_Type` (`ID`);
...
ALTER TABLE `Service`
  ...
  ADD CONSTRAINT `Service_fk3` FOREIGN KEY (`work_place_id`) REFERENCES `Work_Place` (`ID`),
