...
?>
            ...
            <div class="col-md-8" style="color:#000;margin-top:20px;">
            02. ඒ අනුව <?php echo $province[0]['province'] ?> පළාත්, පළාත් අධ්‍යාපන ලේකම්/පළාත් අධ්‍යාපන අධ්‍යක්ෂ වෙත රාජකාරි සඳහා වාර්තා කොට ඒ බැව්  <?php echo $province[0]['province'] ?> පළාත්, පළාත් අධ්‍යාපන ලේකම්/පළාත් අධ්‍යාපන අධ්‍යක්ෂ මඟින් මා වෙත වාර්තා කරන්න.
            </div>
            ...
            <div class="col-md-12">
                ...
                <ol>
                    ...
                    <li>පළාත් රාජ්‍ය සේවා කොමිෂන් සභාව - <?php echo $province[0]['province'] ?> පළාත </li>
                    <li>ප්‍රධාන ලේකම් - <?php echo $province[0]['province'] ?> පළාත </li>
                    <li>පළාත් අධ්‍යාපන ලේකම් - <?php echo $province[0]['province'] ?> පළාත </li>
