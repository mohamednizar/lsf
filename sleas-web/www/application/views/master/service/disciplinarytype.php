                ...
                <div class="col-md-8">
                    <div class="panel panel-success" style="margin-top:20px;">
                        <div class="panel-heading reg-main-panel">
                            <h3 class="panel-title"> Disciplinary Action Types List </h3>
                        ...
                        <table  class="table table-striped table-hover DynamicTable" border="0" >
                            <tr>
                                <td> <button class="delete_workplace btn btn-large btn-success " id="addNew" ><i class="fa fa-plus"></i></button> Add New Disciplinary Action Type </td>
                                <td> </td>
                                <td> </td>
                            </tr>
                        </table>
                              ...
                              <div class="modal-body">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        <label class="modal_q"> Disciplinary Action Type </label>
...
<script>
    $(document).ready(function(){
        ...
        $('#mnu_service-disciplinarytype').addClass('active');
        getDiscipTypes();
        ...
        $(document).on('click', '.edit', function(){
            ...
            $('#action').val('edit');
            $('#modal_title').text("Edit Disciplinary Action Type");
            $('#modal_submit').text("Save");
            $('#UpdateModal').modal('toggle');
        });
        
        $(document).on('click', '.delete', function(){
            var post_url = "index.php/Main/deleteDiscipType/2";
        ...
        $('#addNew').click(function(){
            ...
            $('#modal_title').text("Add New Disciplinary Action Type");
        ...
        $('#modal_submit').click(function(){
            ...
            if(action == 'edit'){
                var post_url = "index.php/Main/updateDiscipType/2";
                form_data.append('<?php echo $this->security->get_csrf_token_name(); ?>','<?php echo $this->security->get_csrf_hash(); ?>');
                form_data.append('discip_id', discip_id);
                ...
                var post_url = "index.php/Main/addDiscipType/2";
                form_data.append('<?php echo $this->security->get_csrf_token_name(); ?>','<?php echo $this->security->get_csrf_hash(); ?>');
                form_data.append('discip_id', discip_id);
                form_data.append('discip_name', discip_name);
                $.ajax({
            ...
            $.ajax({
                ...
                success: function(res){
                    ...
                    $.each(res, function(ID,province_office){
                        $('#dataTable tbody').append('<tr><td>'+res[ID].action_type+'</td>'+
                                                       '<td> <button class="edit btn btn-xs btn-success " data-ID="'+res[ID].ID+'" data-name="'+res[ID].action_type+'" ><i class="fa fa-edit"></i></button> ' +
